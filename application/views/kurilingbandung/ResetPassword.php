            ...
            <div class="wrap-login100">
                <form action="<?php echo $action; ?>" method="post" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-40 col-12" data-validate="Type user name">
                        <input id="first-name" class="input100" type="password" name="password" placeholder="Password" value="<?php echo $password; ?>">
                        <span class="focus-input100"></span>
                    </div>

                    <?php echo form_error('confirm_password') ?>
                    <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-40 col-12" data-validate="Type user name">
                        <input id="first-name" class="input100" type="password" name="confirm_password" placeholder="Confirm Password" value="<?php echo $confirm_password; ?>">
                        <span class="focus-input100"></span>
                    </div>

                    <input type="hidden" class="input100" name="NIK" id="password" placeholder="NIK" value="<?php echo $NIK; ?>" />
                    ...
                    <div class="w-full text-center p-t-27 p-b-50"></div>
                </form>
