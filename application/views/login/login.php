                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        ...
                                        <div class="toolbar clearfix">
                                            <div>
                                                <?php echo anchor(site_url('auth/forgotpassword'),'<i class="ace-icon fa fa-arrow-left"></i> I forgot my password</a>', 'class="forgot-password-link"'); ?>
                                            </div>

                                            <div>
                                                <?php echo anchor(site_url('auth/reg'),'<i class="ace-icon fa fa-arrow-right"></i> I want to register</a>', 'class="user-signup-link"'); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
