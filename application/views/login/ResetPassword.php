                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="<?php echo $action; ?>" method="post">
                                                <div style="margin-top: 8px" id="message">
                                                    ...
                                                    <input type="hidden" class="form-control" name="NIK" id="password" placeholder="NIK" value="<?php echo $NIK; ?>" />
                                                    ...
                                                    <label class="block clearfix"><?php echo form_error('confirm_password') ?>
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" class="form-control" name="confirm_password" id="confirm_password" placeholder="Confirm Password" value="<?php echo $confirm_password; ?>" />
                                                            <i class="ace-icon fa fa-user"></i>
                                                        </span>
                                                    </label>
                                        ...
                                        <div class="toolbar center">
                                            <div>
                                                <?php echo anchor(site_url('auth/login'),'<i class="ace-icon fa fa-arrow-right"></i> Back To Login</a>', 'class="back-to-login-link"'); ?>        
                                            </div>
                                        </div>
                                    </div>
                                </div>
